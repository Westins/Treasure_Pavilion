...
public class StaticPeram {
	...
	final static String accessKeyId = "LTAIz2aDOA5rZTkV";// 你的accessKeyId,填你自己的 上文配置所得  自行配置

	final static String accessKeySecret = "oTaDW5MsLvYgN5MQMvWpslS1Si3tFg";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置

	// 必填:短信签名-可在短信控制台中找到

	final static String SignName = "宝阁商城";    // 阿里云配置你自己的短信签名填入

	// 必填:短信模板-可在短信控制台中找到

	final static String TemplateCode = "SMS_167525875"; // 阿里云配置你自己的短信模板填入
